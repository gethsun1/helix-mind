...
export default function InvestigationPage() {
  ...
  const planningDegraded = (investigation?.researchPlan?._metadata as Record<string, unknown> | undefined)?.planning_status === 'DEGRADED';
